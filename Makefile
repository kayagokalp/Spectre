...
gpu:
	nvcc -ccbin g++ -o f_gpuspec_layers.out src/*.cpp src/cuda-allocators/*.cpp -std=c++11 -O3  -Xcompiler -fopenmp  -I/usr/include/mkl -lmkl_rt -lcublas -lcusolver -DGPU -I/data/aakyildiz/Apps/eigen/ -I/data/aakyildiz/Apps/spectra/include/ -Xcompiler -DNDEBUG
gpu-debug:
